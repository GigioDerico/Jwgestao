...
import { Clock, Users, BookOpen, Target, History, Settings, MoreHorizontal, MapPinned } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/ministry/field-day', label: 'Saída de Campo', icon: MapPinned },
